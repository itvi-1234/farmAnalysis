...
import { Users, Phone, Mail, MapPin, Search, MessageCircle, ShoppingCart } from "lucide-react";
...
const FindCustomers = () => {
  ...
  const fetchCustomers = async () => {
    try {
      // Fetch vendors who want to buy crops
      const q = query(collection(db, "vendors"), where("services", "array-contains", "buyCrops"));
  ...
  const filteredCustomers = customers.filter(
    (customer) =>
      ...
      customer.cropsInterested?.some((crop) =>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-base">
              Connect with vendors and buyers interested in purchasing your crops
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600">
                {searchTerm
                  ...
                  : "No customers are currently looking to buy crops. Check back later!"}
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCustomers.map((customer) => (
                ...
                >
                  ...
                  {customer.cropsInterested && customer.cropsInterested.length > 0 && (
                    <div className="mb-4">
                      <p className="text-xs font-semibold text-gray-700 mb-2">Interested in:</p>
                      <div className="flex flex-wrap gap-2">
                        {customer.cropsInterested.map((crop, idx) => (
                          <span
                            key={idx}
